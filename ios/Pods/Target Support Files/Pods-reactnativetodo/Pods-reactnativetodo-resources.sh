...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  install_resource "${PODS_CONFIGURATION_BUILD_DIR}/FRAuth/FRAuth.bundle"
  install_resource "${PODS_CONFIGURATION_BUILD_DIR}/FRCore/FRCore.bundle"
  install_resource "${PODS_CONFIGURATION_BUILD_DIR}/FRProximity/FRProximity.bundle"
